...
## 3: animate right square moving 3 times faster
# The casuality remains. Instead of a transfer of momentum, this experiment seems like the left square trigger the right one.
distance_travel = 400
traveled_distance = 0
speed_ratio = 3
speed_right = speed_ratio * step_size

while traveled_distance < distance_travel:
    right_square.move((speed_right, 0))
